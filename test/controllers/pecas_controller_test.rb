...
class PecasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create peca" do
    assert_difference("Peca.count") do
      post pecas_url, params: { peca: { classificacao: @peca.classificacao, descricao: @peca.descricao, duracao: @peca.duracao, titulo: @peca.titulo } }
    end
  ...
  test "should update peca" do
    patch peca_url(@peca), params: { peca: { classificacao: @peca.classificacao, descricao: @peca.descricao, duracao: @peca.duracao, titulo: @peca.titulo } }
