class PecasController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to pecas_path, status: :see_other, notice: "Peca was successfully destroyed." }
  ...
  private
    ...
    def set_peca
      @peca = Peca.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def peca_params
      params.expect(peca: [ :titulo, :descricao, :duracao ])
    end
end
